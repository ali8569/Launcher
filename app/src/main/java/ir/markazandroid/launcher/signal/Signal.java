package ir.markazandroid.launcher.signal;
...
public class Signal implements Serializable {
    ...
    public static final int SIGNAL_3PARTY_APP_ADDED =0x00000800;
    public static final int SIGNAL_3PARTY_APP_REMOVED =0x00001000;
